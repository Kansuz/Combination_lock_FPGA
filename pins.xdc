...
set_property PACKAGE_PIN V16 [get_ports {password[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[0]}]
set_property PACKAGE_PIN W16 [get_ports {password[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[1]}]
set_property PACKAGE_PIN W17 [get_ports {password[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[2]}]
set_property PACKAGE_PIN W15 [get_ports {password[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[3]}]
set_property PACKAGE_PIN V15 [get_ports {password[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[4]}]
set_property PACKAGE_PIN W14 [get_ports {password[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[5]}]
set_property PACKAGE_PIN W13 [get_ports {password[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {password[6]}]
set_property PACKAGE_PIN V2 [get_ports {password[7]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports button1]
